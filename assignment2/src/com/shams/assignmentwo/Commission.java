package com.shams.assignmentwo;
...
public class Commission {
	...
	public void calculateCommission() {
		if (salesAmount >= 100000)
			...
			commission = 0;
		System.out.println("The total commission on your sales amount is: " + commission);
	}
	
	// Main method.
	public static void main(String[] args) {
		Student obj = new Student();
		obj.doSomething();  // Use the Student object to avoid the unused variable warning
